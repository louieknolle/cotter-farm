...
const CsaJoin = () => {
  return (
    <div className="flex flex-col items-center w-3/4 bg-white mt-48 mx-auto p-4">
      <h6 className="text-2xl font-semibold text-gray-800 p-2">CSA</h6>
      <div className="flex flex-col justify-center items-center text-xl mt-6 max-w-3xl">
        <p className="">
